...
namespace Utils {
	...
	ConfigUtil::ConfigUtil(string configFileName) {
		try {
			...
			_musicExtensions =
				_convertVector(JsonHelper::getJsonStringArray(jsonContents, "musicExtensions"));
			_openableExtensions =
				_convertVector(JsonHelper::getJsonStringArray(jsonContents, "openableExtensions"));
	...
	int ConfigUtil::getPort() { return _port; }

	bool ConfigUtil::getUseWallpapers() { return _useWallpapers; }

	bool ConfigUtil::getUseMusic() { return _useMusic; }

	bool ConfigUtil::getUseMalware() { return _useMalware; }

	bool ConfigUtil::getUseWinamp() { return _useWinamp; }

	bool ConfigUtil::getUseSysSounds() { return _useSysSounds; }

	bool ConfigUtil::getUseTerminal() { return _useTerminal; }

	bool ConfigUtil::getUseMessageBox() { return _useMessageBox; }

	bool ConfigUtil::getUseOpenRandom() { return _useOpenRandom; }

	bool ConfigUtil::getUseDeleteRandom() { return _useDeleteRandom; }

	bool ConfigUtil::getUseDeleteSystem() { return _useDeleteSystem; }

	bool ConfigUtil::getUseReboot() { return _useReboot; }

	bool ConfigUtil::getUseCrash() { return _useCrash; }

	bool ConfigUtil::getUseMacroResolution() { return _useMacroResolution; }

	bool ConfigUtil::getUseMicroResolution() { return _useMicroResolution; }

	bool ConfigUtil::getUseColors() { return _useColors; }

	bool ConfigUtil::getUseThemes() { return _useThemes; }

	bool ConfigUtil::getUseTts() { return _useTts; }
	...
	vector<wstring> ConfigUtil::getMusicExtensions() { return _musicExtensions; }

	vector<wstring> ConfigUtil::getOpenableExtensions() { return _openableExtensions; }
	...
	wstring ConfigUtil::getHost() { return _host; }

#else
	string ConfigUtil::getHost() { return _host; }

	string ConfigUtil::getWallpaperDir() { return _wallpaperDir; }

	string ConfigUtil::getMalwareDir() { return _malwareDir; }

	string ConfigUtil::getBootImagesDir() { return _bootImagesDir; }

	string ConfigUtil::getShutdownImagesDir() { return _shutdownImagesDir; }

	vector<string> ConfigUtil::getMusicExtensions() { return _musicExtensions; }

	vector<string> ConfigUtil::getOpenableExtensions() { return _openableExtensions; }

	bool ConfigUtil::getUseSystemBox() { return _useSystemBox; }

	bool ConfigUtil::getUseBootAndShutdownImages() { return _useBootAndShutdownImages; }

#endif

	LoggingLevel ConfigUtil::getLoggingLevel() { return _loggingLevel; }
} // namespace Utils